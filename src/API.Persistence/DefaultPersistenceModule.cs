...
public class DefaultPersistenceModule : Module
{
  protected override void Load(ContainerBuilder builder)
  {
    ...
    builder
      .RegisterType<CompanySettingsRepositoryAdapter>()
      .AsImplementedInterfaces()
      .InstancePerLifetimeScope();

    builder
      .RegisterType<CompanySettingsMongoRepository>()
      .AsImplementedInterfaces()
      .InstancePerLifetimeScope();
    ...
    builder.RegisterType<DepartmentMongoRepository>()
      .AsImplementedInterfaces()
      .InstancePerLifetimeScope();

    builder.RegisterType<DepartmentRepositoryAdapter>()
      .AsImplementedInterfaces()
      .InstancePerLifetimeScope();
  }
}
